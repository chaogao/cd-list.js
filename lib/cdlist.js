...
/***/ function(module, exports, __webpack_require__) {
	...
	var CdList = function (_mixin) {
	  ...
	  function CdList(option, el) {
	    ...
	    _this.option = (0, _extends3.default)({}, _option, option);
	  ...
	  (0, _createClass3.default)(CdList, [{
	    ...
	    value: function _bindHistory() {
	      ...
	      var option = (0, _extends3.default)({}, DEFAULT_HISTORY_CONF, self.option.historyOption);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Filter = function () {
	  function Filter(option) {
	    ...
	    this.option = (0, _extends3.default)({}, _option, option);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Event(name, data) {
	  ...
	  data && (0, _extends3.default)(this, data);
	};
	...
	var EventMixin = function () {
	  function EventMixin() {
	    (0, _classCallCheck3.default)(this, EventMixin);
	  }
	
	  (0, _createClass3.default)(EventMixin, [{
	    key: "on",
